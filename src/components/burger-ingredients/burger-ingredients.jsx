    ...
    return (
        <section className={`${styles.wrap} pt-10`}>
            ...
            <div className={`${styles.ingredients} custom-scroll`}>
                <BurgerTypeIngredients name="Булки" ingredients={buns} />
                <BurgerTypeIngredients name="Соусы" ingredients={sauces} />
                <BurgerTypeIngredients name="Начинка" ingredients={mains} />
            </div>
        </section>
    );
};
